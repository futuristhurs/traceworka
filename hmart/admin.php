...
<!-- Mirrored from htmldemo.net/hmart/hmart/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Jun 2023 08:38:05 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Hmart - Admin page</title>
...
<div class="main-wrapper">
    <!--  <header>
          &lt;!&ndash; Header top area start &ndash;&gt;
          ...
          &lt;!&ndash; Header top area end &ndash;&gt;
          &lt;!&ndash; Header action area start &ndash;&gt;
                  ...
                  <div class="row justify-content-between align-items-center">
                      ...
                      <div class="col-lg-3 col">
                          <div class="header-actions">
                              &lt;!&ndash; Single Wedge Start &ndash;&gt;
                              <a href="#offcanvas-wishlist" class="header-action-btn offcanvas-toggle">
                                  <i class="pe-7s-like"></i>
                              </a>
                              &lt;!&ndash; Single Wedge End &ndash;&gt;
                              <a href="#offcanvas-cart" class="header-action-btn header-action-btn-cart offcanvas-toggle pr-0">
                                  <i class="pe-7s-shopbag"></i>
                                  <span class="header-action-num">01</span>
                                  &lt;!&ndash; <span class="cart-amount">€30.00</span> &ndash;&gt;
                              </a>
          ...
          &lt;!&ndash; Header action area end &ndash;&gt;
          &lt;!&ndash; Header action area start &ndash;&gt;
          ...
          &lt;!&ndash; Header action area end &ndash;&gt;
          &lt;!&ndash; header navigation area start &ndash;&gt;
          ...
          &lt;!&ndash; header navigation area end &ndash;&gt;
          <div class="mobile-search-box d-lg-none">
              <div class="container">
                  &lt;!&ndash; mobile search start &ndash;&gt;
    ...
    <!--<div id="offcanvas-mobile-menu" class="offcanvas offcanvas-mobile-menu">
        ...
        <div class="inner customScroll">
            ...
            &lt;!&ndash; OffCanvas Menu End &ndash;&gt;
                                ...
                                <div class="login-form-container">
                                    <div class="login-register-form">
                                        <form action="#" method="post">
                                            ...
                                            <input name="user-email" placeholder="Email" type="email" />
                                            <input type="password" name="user-password" placeholder="Password" />
                                            <input type="password" name="user-password" placeholder="Re-Type Password" />
                                            <div class="button-box">
                        ...
                        <div class="col-md-6 col-lg-3 col-sm-12">
                            <div class="single-wedge">
                                ...
                                <div class="footer-links">
                                    ...
                                    &lt;!&ndash; News letter area  End &ndash;&gt;
                                </div>
                            </div>
                        </div>
                        &lt;!&ndash; End single blog &ndash;&gt;
