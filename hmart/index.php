...
<!-- Mirrored from htmldemo.net/hmart/hmart/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Jun 2023 08:36:15 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Traceworka - Home One</title>
                        ...
                        <div class="col d-none d-lg-block">
                            <div class="top-nav">
                                <ul>
                                    ...
                                    <li><a href="tel:+234 907 154 3344"><i class="fa fa-phone"></i> +234 907 154 3344</a></li>
                                    <li><a href="mailto:hello@traceworka.ng"><i class="fa fa-envelope-o"></i>hello@traceworka.ng</a></li>

                                    <li><a href="login.php"><i class="fa fa-user"></i> Register/Login</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
c                                <li class="dropdown position-static"><a href="about.php">Pages <i class="fa fa-angle-down"></i></a>
                            ...
                            <div class="row h-100">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 align-self-center sm-center-view">
                                    <div class="hero-slide-content slider-animated-1">
                                        <span class="category">Welcome To Trace Worka</span>
                                        <h2 class="title-1">Your Home <br>
                                        Smart Devices & <br>
                                         Best Solution </h2>
                                        <a href="shop-left-sidebar.php" class="btn btn-primary text-capitalize">Shop All Devices</a>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="single-banner nth-child-1">
                            ...
                            <div class="banner-content nth-child-1">
                                ...
                                <a href="shop-left-sidebar.php" class="shop-link"><i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                                ...
                                <div class="row mb-n-30px">
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                        ...
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                <span class="category"><a href="#">Accessories</a></span>
                                                <h5 class="title"><a href="single-product.php">Bluetooth Headphone
                                                    </a>
                                                </h5>
                                                <span class="price">
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                        ...
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                <span class="category"><a href="#">Accessories</a></span>
                                                <h5 class="title"><a href="single-product.php">Smart Music Box
                                                    </a>
                                                </h5>
                                                <span class="price">
                                                    <span class="new">$48.50</span>
                                                </span>
                                            </div>
                                            <div class="actions">
                                                <button title="Add To Cart" class="action add-to-cart" data-bs-toggle="modal" data-bs-target="#exampleModal-Cart"><i
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                        ...
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                <span class="category"><a href="#">Accessories</a></span>
                                                <h5 class="title"><a href="single-product.php">Air Pods 25Hjkl Black
                                                    </a>
                                                </h5>
                                                <span class="price">
                                                    <span class="new">$38.50</span>
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                        ...
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                <span class="category"><a href="#">Accessories</a></span>
                                                <h5 class="title"><a href="single-product.php">Smart Hand Watch
                                                    </a>
                                                </h5>
                                                <span class="price">
                                                    <span class="new">$38.50</span>
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                        ...
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                <span class="category"><a href="#">Accessories</a></span>
                                                <h5 class="title"><a href="single-product.php">Smart Table Camera
                                                    </a>
                                                </h5>
                                                <span class="price">
                                                    <span class="old">$128.50</span>
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                        ...
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                <span class="category"><a href="#">Accessories</a></span>
                                                <h5 class="title"><a href="single-product.php">Round Pocket Router
                                                    </a>
                                                </h5>
                                                <span class="price">
                                                    <span class="new">$38.50</span>
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px">
                                        ...
                                        <div class="product">
                                            ...
                                            <div class="content">
                                                <span class="category"><a href="#">Accessories</a></span>
                                                <h5 class="title"><a href="single-product.php">Power Bank 10000Mhp
                                                    </a>
                                                </h5>
                                                <span class="price">
            ...
            <div class="container h-100">
                <div class="row justify-content-center align-items-center h-100">
                    <div class="col-12 text-center">
                        ...
                        <a href="shop-left-sidebar.php" class="btn btn-primary text-capitalize m-auto">Shop All Devices</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xl-6 col-lg-6 mb-md-35px mb-lm-35px">
                        <div class="single-feature-content">
                            ...
                            <div class="top-content">
                                <h4 class="title"><a href="single-product.php">Bluetooth Headphone </a></h4>
                                <span class="price">
                            ...
                            <div class="bottom-content">
                                ...
                                <a href="single-product-variable.php" class="btn btn-primary  m-auto"> Shop
                                    Now </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="feature-right-content">
                            ...
                            <div class="content-side">
                                ...
                                <div class="prize-content">
                                    <h5 class="title"><a href="single-product.php">Ladies Smart Watch</a></h5>
                                    <span class="price">
                                        <span class="old">$48.50</span>
                                        <span class="new">$38.50</span>
                                    </span>
                            ...
                            <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                                <div class="single-wedge">
                                    <div class="footer-logo">
                                        <a href="index.php"><img src="assets/images/logo/logos.png" alt=""></a>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-3 col-sm-12">
                                <div class="single-wedge">
                                    ...
                                    <div class="footer-links">
                                        ...
                                        <p class="address">Address: St. James House, 167 Adetokunbo Ademola Crescent, Wuse 2 Abuja</p>
                                        <p class="phone">Phone/Fax:<a href="tel:+234 907 154 3344"> +234 907 154 3344</a></p>
                                        <p class="mail">Email:<a href="mailto:hello@traceworka.ng"> hello@traceworka.ng</a></p>
                                        <p class="mail"><a href="https://traceworka.ng/"> traceworka.ng</a></p>
                                        <p class="mail"><a href="https://hello@traceworka.ng/"> Hello@Traceworka.NG</a></p>
...
<!-- Mirrored from htmldemo.net/hmart/hmart/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Jun 2023 08:37:09 GMT -->
</html>