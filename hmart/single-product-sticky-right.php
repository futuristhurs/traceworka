...
<!-- Mirrored from htmldemo.net/hmart/hmart/single-product-sticky-right.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Jun 2023 08:38:07 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="main-wrapper">
        ...
        <div class="product-details-area pt-100px pb-100px">
            <div class="container">
                <div class="row flex-lg-row-reverse flex-xl-row-reverse">
                        ...
                        <div class="single-product-sticky mb-30px">
                            <div class="single-product-slider-wrapper d-flex flex-wrap mb-n-30px">
                                <div class="single-product-slider-item mb-30px" data-aos="fade-up" data-aos-delay="200">
                                    <a class="venobox" data-gall="myGallery" href="assets/images/product-image/zoom-image/1.webp"><img class="img-responsive" src="assets/images/product-image/1.webp" alt="slider-item-img"></a>
                                </div>
                                <div class="single-product-slider-item mb-30px swiper-slide" data-aos="fade-up" data-aos-delay="400">
                                    <a class="venobox" data-gall="myGallery" href="assets/images/product-image/zoom-image/5.webp"><img class="img-responsive" src="assets/images/product-image/2.webp" alt="slider-item-img"></a>
                                </div>
                                <div class="single-product-slider-item mb-30px swiper-slide" data-aos="fade-up" data-aos-delay="200">
                                    <a class="venobox" data-gall="myGallery" href="assets/images/product-image/zoom-image/4.webp"><img class="img-responsive" src="assets/images/product-image/3.webp" alt="slider-item-img"></a>
                                </div>
                                <div class="single-product-slider-item mb-30px swiper-slide" data-aos="fade-up" data-aos-delay="400">
                                    <a class="venobox" data-gall="myGallery" href="assets/images/product-image/zoom-image/2.webp"><img class="img-responsive" src="assets/images/product-image/4.webp" alt="slider-item-img"></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from htmldemo.net/hmart/hmart/single-product-sticky-right.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Jun 2023 08:38:08 GMT -->
</html>