...
<head>
    ...
    <title>Traceworka- Contact page</title>
    <meta name="robots" content="index, follow" />
    <meta name="description" content="Traceworka-Smart Product eCommerce html Template">
    <!-- Favicon -->
...
<body>
    <div class="main-wrapper">
        <header>
            ...
            <div class="header-navd-none d-lg-block sticky-nav">
                <div class="container">
                            ...
                            <div class="contact-info">
                                <div class="single-contact">
                                    ...
                                    <div class="info-box">
                                        ...
                                        <p>St. James House, 167 Adetokunbo Ademola Crescent, Wuse 2 <br>
                                        904101, 900108,FCT Abuja.</p>
                                    </div>
                                </div>
                                <div class="single-contact">
                                    <div class="icon-box">
                                    ...
                                    <div class="info-box">
                                        ...
                                        <p><a href="tel:+234 907 154 3344">+234 907 154 3344</a></p>
                                        <p><a href="tel:0903 144 1802">+234 903 144 1802</a></p>
                                    </div>
                                </div>
                                <div class="single-contact m-0">
                                    ...
                                    <div class="info-box">
                                        ...
                                        <p><a href="mailto:hello@traceworka.ng">hello@traceworka.ng</a></p>
                                        <p><a href="https://traceworka.ng/">www.traceworka.ng</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 col-lg-3 col-sm-12">
                                <div class="single-wedge">
                                    ...
                                    <div class="footer-links">
                                        ...
                                        <p class="mail">Website:<a href="https://traceworka.ng/"> traceworka.ng</a></p>
                        ...
                        <div class="line-shape-top line-height-1">
                            <div class="row flex-md-row-reverse align-items-center">
                                ...
                                <div class="col-md-6 text-center text-md-start">
                                    <p class="copy-text"> © 2022 <strong>Traceworka</strong> Made With <i class="fa fa-heart"
                                        aria-hidden="true"></i> By <a class="company-name" href="https://themeforest.net/user/codecarnival/portfolio">
                                            <strong> thatgurlfay</strong></a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
